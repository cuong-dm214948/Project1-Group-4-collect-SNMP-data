...
public class UsmUserEntry implements Serializable, Comparable<UsmUserEntry> {
    ...
    /**
     * Creates a user with username and associated {@link UsmUser}.
     *
     * @param userName
     *         the username of the new entry.
     * @param engineID
        ...
        this.usmUser =
                new UsmUser(userName, authProtocol,
                        ((authenticationKey != null) ?
                                new SecretOctetString(authenticationKey) : null),
                        privProtocol,
                        ((privacyKey != null) ?
                                new SecretOctetString(privacyKey) : null), this.engineID);
    }
     ...
     * @return
     *    an object previously set by {@link #setOwnerReference(Object)} or {@code null} (default).
     * @since 3.6.3
     */
    public Object getOwnerReference() {
        return ownerReference == null ? null : ownerReference.get();
    }

    /**
     * Sets the (weak) owner reference of this user entry. If the owner is deleted, this reference disappears and
     * {@link #getOwnerReference()} returns {@code null}.
     * @param ownerReference
     *    an object identifying itself as owner of this entry (i.e. this object may ignore
     *    {@link org.snmp4j.event.UsmUserEvent}s of this object while this reference is present.
     * @since 3.6.3
     */
    public void setOwnerReference(Object ownerReference) {
        this.ownerReference = new WeakReference<>(ownerReference);
    }
