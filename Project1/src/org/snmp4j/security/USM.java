...
public class USM extends SNMPv3SecurityModel {
    ...
    /**
     * Looks up a {@link org.snmp4j.security.UsmUserEntry} by an engine ID and security name. If an user exists that is
     ...
     *         a security name.
     *
     * @return an localized {@link org.snmp4j.security.UsmUserEntry} if the provided engineID's length is greater than
    ...
    /**
     * Updates the USM user entry with the same engine ID and user name as the supplied instance and fires an
    ...
    /**
     * Removes all USM user from the internal user name table with the specified user name and (optional) engine ID. If
     * the engine ID is not provided (null) then any user (including localized) are removed that have the specified user
     * name.
     *
     * @param userName
     *         a user name.
    ...
    /**
     * Removes all USM user from the internal user name table with the specified user name. This is the same as {@link
