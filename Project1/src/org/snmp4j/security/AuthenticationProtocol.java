...
/**
 * The {@code AuthenticationProtocol} interface defines a common
...
public interface AuthenticationProtocol extends SecurityProtocol {
     ...
     * given message. The parameter {@code digestOffset} offset is pointing
     ...
     * @param messageOffset
     *    the offset in {@code message} where the message actually starts.
     * @param messageLength
     *    the actual message length (may be smaller than
     *    {@code message.length}).
     * @param digest
     *    the offset in {@code message} where to store the digest.
     * @return
     *    {@code true} if the message digest has been successfully computed
     *    and set, {@code false} otherwise.
     */
     ...
     *    {@code message.length}).
     * @param digest
     *    the digest of the {@code message}.
     * @return
     *    {@code true} if the message is authentic, {@code false}
     *   otherwise.
     */
