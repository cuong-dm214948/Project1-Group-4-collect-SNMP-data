...
public class UsmUserTable implements Serializable {
    ...
    private final Map<UsmUserKey, UsmUserEntry> table = new TreeMap<UsmUserKey, UsmUserEntry>();

    public UsmUserTable() {
    }

    /**
     * Adds or replaces any existing entry with same engineID and securityName combination, see {@link UsmUserKey}.
     * @param user
     *   the localized USM user entry.
     * @return
     *   the previously registered entry with same engineID and securityName or otherwise {@code null}.
     */
    ...
    /**
     * The {@code UsmUserKey} class defines the unique key for {@link UsmUserTable} by engineID and securityName.
     */
