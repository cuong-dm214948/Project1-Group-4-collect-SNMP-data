...
/**
 * A {@code VariableBinding} is an association of a object instance
...
public class VariableBinding
     ...
     * @param oid
     *    the OID for the new variable binding (must not be {@code null}).
     * @param variable
     *    the value for the new variable binding (must not be {@code null}).
     */
     ...
     * this operation. To be able to use this constructor, register the {@code SmiManager}
     * of SNMP4J-SMI instead as {@link VariableTextFormat} instead.
     *
     * @param oid
     *    the {@link OID} of the new variable binding.
     * @param variableText
     *    the textual representation of a {@link Variable} of the syntax defined for {@code oid}
     *    by a MIB specification.
     * @throws ParseException
     *    if the {@code variableText} cannot be parsed or {@code oid}'s syntax is unknown.
     * @since 2.2
     */
     ...
     * @param oid
     *    an OID (must not be {@code null}) that is cloned when added to
     *    this binding.
     */
     ...
     *
     * @param variable
     *    a {@code Variable} (must not be {@code null}) that is cloned
     ...
     * @return
     *    a string of the form {@code <OID> = <Variable>}.
     */
     ...
     * {@link VariableTextFormat} configured by {@link SNMP4JSettings}.
     * @return
     *    a string of the form {@code <Variable>}.
     * @since 1.10
     */
