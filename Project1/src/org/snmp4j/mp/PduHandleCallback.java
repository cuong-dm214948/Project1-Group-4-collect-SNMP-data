...
/**
 * The {@code PduHandleCallback} can be used to get informed about a
 * {@code PduHandle} creation before a request is actually sent out.
 *
 * @author Frank Fock
 * @version 1.8
 * @since 1.8
...
public interface PduHandleCallback<P> {
   ...
   *
   * @param handle
   *   a {@code PduHandle} instance that uniquely identifies a request -
