...
/**
 * The {@code PduHandle} class represents an unique key for a SNMP PDU.
...
public class PduHandle implements Serializable {
    ...
    /**
     * Creates a {@code PduHandle} with a transaction ID set to {@link #NONE}.
     */
    public PduHandle() {
    }

    /**
     * Creates a {@code PduHandle} for the supplied transaction ID.
     * @param transactionID
    ...
    /**
     * Copy all members from the supplied {@code PduHandle}.
     * @param other
     *    a PduHandle.
     */
