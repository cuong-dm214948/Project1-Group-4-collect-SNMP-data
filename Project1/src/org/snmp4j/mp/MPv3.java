...
public class MPv3 implements MessageProcessingModel, EngineIdCacheSize {
    ...
    protected static class Cache {
        ...
        private final Map<MessageID, WeakReference<PduHandle>> msgIdToPduHandleMapping = new WeakHashMap<>(25);
    ...
    public <A extends Address> int prepareResponseMessage(int messageProcessingModel,
        ...
        if (cacheEntry == null) {
            if (logger.isDebugEnabled()) {
                logger.debug("RFC3412 §7.1 - Preparing response or internal message failed (msgID=" +
                        stateReference.getMsgID() + ") because cached " +
