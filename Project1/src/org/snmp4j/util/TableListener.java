...
/**
 * The {@code TableListener} interface is implemented by objects
...
public interface TableListener extends EventListener {
     ...
     *    {@code TableListener} can return {@code false} to stop
     *    table retrieval.
     */
     ...
     * @param event
     *    a {@code TableEvent} instance that will either indicate an error
     *    ({@link TableEvent#isError()} returns {@code true}) or success
