...
/**
 * The {@code AbstractSnmpUtility} is an abstract base class for
...
public abstract class AbstractSnmpUtility {
  ...
  /**
   * Creates a {@code AbstractSnmpUtility} instance. The created instance
   * is thread safe as long as the supplied {@code Session} and
