...
/**
 * The {@code VariableTextFormat} provides a textual representation
...
public interface VariableTextFormat {
     ...
     *
     * @param instanceOID
     *    the instance OID {@code variable} is associated with.
     *    If {@code null} the formatting cannot take any MIB specification
     *    of the variable into account and has to format it based on its type
     *    only.
     * @param variable
     *    the variable to format.
     * @param withOID
     *    if {@code true} the {@code instanceOID} should be included
     ...
     * @return
     *    the new {@code VariableBinding} instance.
     ...
     *    the instance OID {@code variable} is associated with. Must not
     *    be {@code null}.
     * @param text
     *    a textual representation of the variable.
     * @return
     *    the new {@code Variable} instance.
     * @throws ParseException
     ...
     * @param smiSyntax
     *    the SMI syntax identifier identifying the target {@code Variable}.
     * @param text
     *    a textual representation of the variable.
     * @return
     *    the new {@code Variable} instance.
