...
/**
 * The {@code DefaultPDUFactory} is a default implementation of the
 * {@code PDUFactory} interface. It creates PDUs depending on the
...
public class DefaultPDUFactory implements PDUFactory {
    ...
    /**
     * Create a {@code PDU} instance for the supplied target.
     *
     * @param target the {@code Target} where the PDU to be created will be
     *   sent.
    ...
    /**
     * Create a {@code PDU} instance for the supplied target. For GETBULK
    ...
    /**
     * Creates a {@code PDU} instance for the specified SNMP version.
     * @param targetVersion
    ...
    /**
     * Creates a {@code PDU} instance for the specified {@link MessageProcessingModel}.
    ...
    /**
     * Creates a {@code PDU} instance for the specified {@link MessageProcessingModel} and PDU type.
     * @param messageProcessingModel
     *    a message processing model instance.
     * @param pduType
     ...
     * by this factory.
     * @return
     *    the context engine ID or {@code null} if context engine ID is
     ...
     *
     * @return
     *    the context name or {@code null} for the default context.
     * @since 2.2
     */
