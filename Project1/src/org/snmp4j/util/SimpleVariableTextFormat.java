...
/**
 * The {@code SimpleVariableTextFormat} implements a simple textual
...
public class SimpleVariableTextFormat implements VariableTextFormat {
     ...
     *
     * @param instanceOID the instance OID {@code variable} is associated
     *   with. If {@code null} the formatting cannot take any MIB
     ...
     * @return the new {@code Variable} instance.
