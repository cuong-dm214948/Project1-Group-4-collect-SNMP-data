 ...
 * <p>
 * At the same time a {@code CounterEvent}
 ...
 * must set the new value when receiving the {@code CounterEvent} by using
...
public class CounterEvent extends EventObject {
    ...
    /**
     * Creates a {@code CounterEvent} for the specified counter.
     * @param source
     ...
     * @return
     *    the row index identifier for this counter event or {@code null} if the counter is a scalar value.
     * @since 2.4.2
     */
