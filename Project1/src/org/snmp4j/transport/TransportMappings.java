...
public class TransportMappings {
    ...
    /**
     * Register a transport mapping to be recognised by this {@link TransportMappings} singleton. If this method
     * has not been called yet, the {@link #registerTransportMappings()} will be called to register default
     * transport mappings first.
     * @param transportMappingClass
     *    a Class extending {@link TransportMapping}.
     * @param addressClass
     *    the primary address Class extending {@link Address} that can be used with that transport mapping.
     * @since 3.7.1
     */
    public <A extends Address> void registerTransportMapping(
            Class<? extends TransportMapping<A>> transportMappingClass,
     ...
     * @param addressClass
     *    the primary address Class extending {@link Address} that the transport mapping to be removed was
     *    registered with.
     * @return
     *    the removed transport mapping registration or {@code null}.
     * @param <A> the address class
     * @since 3.7.1
     */
