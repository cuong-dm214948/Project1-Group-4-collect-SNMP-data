...
public class DefaultTlsTmSecurityCallback implements TlsTmSecurityCallback<X509Certificate> {
    ...
    private final Map<SecurityNameMapping, OctetString> securityNameMapping = new HashMap<SecurityNameMapping, OctetString>();
    private final Map<Address, String> localCertMapping = new HashMap<Address, String>();
    private final Set<String> acceptedSubjectDN = new HashSet<String>();
    private final Set<String> acceptedIssuerDN = new HashSet<String>();
